...
An \myacro{ASCII}-armored OpenPGP Message encrypted with the subkey contained in the Transferable Public Key shown in figure \ref{fig:key} is shown in figure \ref{fig:msg}. The internal structure of this message is explained in figure \ref{fig:transferable-msg}. \\
