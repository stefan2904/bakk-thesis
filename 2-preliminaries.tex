...
For example the fingerprint can be the 160-bit SHA-1 hash of a key, while the key id are the lower 64 bits of the fingerprint. Due to the nature of a hash function it is possible that collisions exist.
