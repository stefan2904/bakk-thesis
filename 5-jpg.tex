...
As practical part of this thesis we did an implementation of the openPGP message format \todo{RFC4880} in the \textit{Java} programing language, creating a library workingtitled \textbf{Java Privacy Guard}.

For cryptographic primitives like basic data types, encryption and digest algorithms we used the \textit{IAIK-JCE} library. \\

The Packet- and Transferable-structure as described in chapter \ref{chapter:messageformat} represents the base-structure of our implementation. All Packets defined in \todo{RFC4880} are implemented as one or more Java-classes. Additionally all relevant Packet-compositions are implemented in the form of Transferable-classes as defined in \todo{RFC4880}. \\
...
Security concerns, as long as they affect the actual design of the openPGP standard, are discussed in chapter \ref{cha:abstract} and in \todo{RFC4880}.  \\
