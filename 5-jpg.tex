...
% completely change this chapter, make it shorter shorter!
% rename thesis?

% only discuss how things mentioned in chapter 3 and 4 are implemented in java
% mainly, explain stream stuff ?
% ()explain reading and/or writing site? or only one?)
% only give overview, explain how things work in principle, give exmple for short usecase 

% explain difference between high-/low-level api

% if all things fail, delete this chapter
