...
To establish a end to end encrypted communication it is therefor necessary to manually create the key-pairs and to establish a manual key exchange as describe in chapter \ref{section:openpgp:principles}. This results in a number of security and usability problems.  \\
...
Another way of doing this is the \textit{Web of Trust}, as described in chapter \ref{section:openpgp:authentication}. \\
