%%%% Time-stamp: <2015-09-25 13:01:11 stm>
%% ========================================================================
%%%% Disclaimer
%% ========================================================================
%%
...
\newcommand{\mymendeleyfile}{mendeley.bib}
...
%% general metadata:
\newcommand{\myauthor}{Stefan J. More}  %% also used for PDF metadata (hyperref)
\newcommand{\mytitle}{Java Privacy Guard}  %% also used for PDF metadata (hyperref)

\newcommand{\mysubject}{The OpenPGP Message Format \\and an Implementation in Java}  %% also used for PDF metadata (hyperref)
%\newcommand{\mysubject}{An implementation of the OpenPGP Message Format in Java}  %% also used for PDF metadata (hyperref)

\newcommand{\mykeywords}{OpenPGP, PGP, Java, End-to-End Encryption}  %% also used for PDF metadata (hyperref)
% PGP, end-to-end encryption, web of trust, privacy
...
\newcommand{\myevaluator}{Dipl.-Ing.~Dieter Bratko} %% your evaluator
\newcommand{\myhomestreet}{Inffeldgasse 16} %% your home street (with house number)
...
\input{2-preliminaries.tex}
% TODO: Wie detailiert?

\input{3-openPGP}

\input{4-theOpenPGPmessageFormat}
