...
\newcommand{\myinstitute}{Institute for Applied Information Processing and Communication} %% affiliation
\newcommand{\myinstitutehead}{O.Univ.-Prof.~Dipl.-Ing.~Dr.techn.~Reinhard Posch} %% head of institute
\newcommand{\mysupervisor}{Dipl.-Ing.~Dieter Bratko} %% your supervisor
...
\input{3-theOpenPGPmessageFormat}   
