...
The OpenPGP standard is actively developed by the OpenPGP Working Group (WG) of the \textit{Internet Engineering Task Force} (\myacro{IETF}). The WG was reopened in 2015 as a reaction to an emerging discussion about secure (and usable) digital messaging.
