...
The OpenPGP standard is actively developed by the OpenPGP Working Group (WG) of the \textit{Internet Engineering Task Force} (\myacro{IETF}). The WG was reopened in 2015 as reaction to an emerging discussion about secure (and usable) digital messaging.
...
The main difference between OpenPGP and \myacro{S/MIME} is the structure of the used trust model.  \\
